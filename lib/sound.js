...
class Sound {
  constructor () {
    ...
    this.playIntroMusic = this.playIntroMusic.bind(this);
    this.playBeats = this.playBeats.bind(this);
    this.stopIntroMusic = this.stopIntroMusic.bind(this);
    this.playDeathMusic = this.playDeathMusic.bind(this);
    this.stopDeathMusic = this.stopDeathMusic.bind(this);
    this.playStoryMusic = this.playStoryMusic.bind(this);
    this.stopBeats = this.stopBeats.bind(this);
    this.allMusic = [
  ...
  playSound(id) {
    if (this.musicActive) {
      ...
      if (id === "blasterFired") {
        ...
        soundEffect.setAttribute("autoplay", "true");
      } else if (id === "addPoints") {
        soundEffect.setAttribute("src", "./audio/addPoints.mp3");
        soundEffect.setAttribute("autoplay", "true");
      } else if (id === "addInitial") {
        soundEffect.setAttribute("src", "./audio/addInitial.mp3");
        soundEffect.setAttribute("autoplay", "true");
      }
    }
  }
